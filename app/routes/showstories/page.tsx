...
export default function TopStories() {
  const [showStories, setshowStories] = useState<StoriesProps[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const showStories: StoriesProps[] = await Promise.all(storyPromises);
      setshowStories(showStories);
      setFilteredStories(showStories);
      setLoading(false);
    };
    fetchData();
  }, []);
  ...
  useEffect(() => {
    const result = showStories.filter((story) =>
